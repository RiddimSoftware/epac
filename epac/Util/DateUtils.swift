...
class DateUtils {
    ...
    private lazy var csvDateFormatter_en: DateFormatterInstance = DateFormatterInstance(format: "yyyy-MM-dd", style: nil, locale: Locale(identifier: "en_CA"))!
    private lazy var csvDateFormatter_fr: DateFormatterInstance = DateFormatterInstance(format: "yyyy-MM-dd", style: nil, locale: Locale(identifier: "fr_CA"))!
    ...
    func getDate(forCSVDateString string: String) -> Date {
        if Locale.current.identifier == "fr_CA" {
    ...
    func getCSVStringFromDate(_ date: Date) -> String {
        if Locale.current.identifier == "fr_CA" {
