...
# GitHub-hosted/self-hosted runners may export AWS_PROFILE globally. These
# scripts rely on the short-lived env credentials produced by
# configure-aws-credentials, so drop profile selectors before calling the AWS
