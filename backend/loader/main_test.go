...
<House>
  ...
  <SubjectOfBusiness id="subject-oral-questions">
...
func TestParseHansard(t *testing.T) {
	...
	if first.SubjectID != "subject-oral-questions" {
		t.Errorf("first.SubjectID = %q, want 'subject-oral-questions'", first.SubjectID)
	}
